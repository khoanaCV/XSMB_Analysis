                      ...
                      <div className="card-body p-md-5 mx-md-4">
                        <div className="mb-4 pb-2 pb-md-0 mb-md-5 text-center">
                          ...
                          <h4 className="mt-1 mb-5 pb-1">
                            NORTHERN VIETNAM LOTTERY STATISTICS AND ANALYSIS
                          </h4>
                        </div>
                    ...
                    <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
                      <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                        ...
                        <p className="small mb-0">
                          The Northern Lottery is drawn alternately by 6
                          provinces and cities with prizes opened by the State
                          with the goal of "Benefiting the country, benefiting
                          the people", building infrastructure, and serving
                          people's lives.
                        </p>
                      </div>
                    </div>
